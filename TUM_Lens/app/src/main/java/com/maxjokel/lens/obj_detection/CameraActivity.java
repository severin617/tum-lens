...
public abstract class CameraActivity extends AppCompatActivity  implements OnImageAvailableListener,
  ...
  protected void setFragment() {
    ...
    if (useCamera2API) {
      ...
      ((LegacyCameraConnectionFragment) fragment).setImageListener(this);
      ((LegacyCameraConnectionFragment) fragment).setLayout(getLayoutId());
      ((LegacyCameraConnectionFragment) fragment).setDesiredSize(getDesiredPreviewFrameSize());
    }
