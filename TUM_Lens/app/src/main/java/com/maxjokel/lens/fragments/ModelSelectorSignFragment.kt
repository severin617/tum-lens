...
class ModelSelectorSignFragment: Fragment(){
    ...
    private var MODEL_LIST = ListSingletonSign.modelConfigs
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_model_selector_sign, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (m in MODEL_LIST) {
            ...
            // this is actually accuracy not top5
...
//        }
        ...
        val id = prefs.getInt("model_sign", 0)
        var r = view.findViewById<RadioButton>(id)
        if (id == 0 || r == null) {
            r = view.findViewById(R.id.radioButton_SimpleNet)
        }
...
//    }
    ...
    companion object {
        fun newInstance(): ModelSelectorSignFragment {
            return ModelSelectorSignFragment()
        }
    }
}