...
import com.maxjokel.lens.detection.CameraConnectionFragment.Companion.chooseOptimalSize
import com.maxjokel.lens.helpers.ImageUtils.getYUVByteSize
...
class LegacyCameraConnectionFragment : Fragment() {
    ...
    var imageListener: PreviewCallback? = null
    var desiredSize: Size? = null
    ...
    private fun startCamera() {
        ...
        try {
            ...
            val previewSize = chooseOptimalSize(
                sizes.toTypedArray(), desiredSize!!.width, desiredSize!!.height
            )
