...
class CameraConnectionFragment private constructor
    ...
    internal class CompareSizesByArea : Comparator<Size?> {
        override fun compare(lhs: Size?, rhs: Size?): Int {
            val lhsWidht = lhs?.width ?: 0 ; val lhsHeight = lhs?.height ?: 0
            val rhsWidht = rhs?.width ?: 0 ; val rhsHeight = rhs?.height ?: 0
            // We cast here to ensure the multiplications won't overflow
            return java.lang.Long.signum(
                lhsWidht.toLong() * lhsHeight - rhsWidht.toLong() * rhsHeight)
        }
    }
