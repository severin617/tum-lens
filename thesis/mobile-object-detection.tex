...
SSD computes category scores and box locations for a fixed set of default bounding boxes by appliying a comparatevely small convulational filter to the feature map returned by the backbone network. %TODO: Stimmt das`?
